    ...
    <div className="new-incident-container">
      <div className="content">
        <section>
          ...
          <p>Descreva o caso detalhamente para encontrar um herói para resolvê-lo.</p>
        ...
        <form onSubmit={handleNewIncident} >
          ...
          <textarea placeholder="Descrição" type="text" value={description} onChange={e => setDescription(e.target.value)} />
